    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="mb-4">
          ...
          that everyone deserves to live a happy and fulfilling life, and we're
          here to help you achieve that.
        </p>
        <p className="mb-4">
          Our team of experienced therapists is dedicated to providing you with
          personalized and effective therapy sessions, tailored to your specific
          needs and goals.
        </p>
        <p className="mb-4">
          Whether you're struggling with anxiety, depression, stress, or any
          other mental health issue, we're here to support you every step of the
          way.
        </p>
      </div>
      <Footer />
